...
from apps.core.views import LandingPageView, ApplicationConfigView, MethodologyView
...
from apps.rbac.views import (
    ...
    ControlPointListView, ControlPointCreateView, ControlPointEditView, ControlPointDeleteView,
    ControlPointGroupListView, ControlPointGroupCreateView, ControlPointGroupEditView, ControlPointGroupDeleteView,
    LookupListView, LookupCreateView, LookupEditView, LookupDeleteView,
)
